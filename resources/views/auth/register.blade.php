...
<div class="wrapper vh-100">
    <div class="row align-items-center h-100">
        <form class="col-lg-6 col-md-8 col-10 mx-auto" id="formAuthentication" method="POST" action="{{ route('register') }}">
            @csrf
           <!-- ERRORS -->
            @if($errors->any())
            <ul>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="inputPassword6">Şifreyi Onaylayın</label>
            ...
            <div>
                <br>
                <a class="mt-5 mb-5 text-center"  href="{{ route('login') }}">
...
<script src="{{asset('panel/js/tinycolor-min.j')}}"></script>
